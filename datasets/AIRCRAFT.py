...
'''
https://github.com/lvyilin/pytorch-fgvc-dataset/tree/master
'''
...
if __name__ == '__main__':
    ...
    train_dataset = Aircraft('/data/dataSets/FGVC_aircraft', train=True, download=False)
    test_dataset = Aircraft('/data/dataSets/FGVC_aircraft', train=False, download=False)
