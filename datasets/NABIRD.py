...
if __name__ == '__main__':
    ...
    train_dataset = NABirds('/data/dataSets/', train=True, download=False)
    test_dataset = NABirds('/data/dataSets/', train=False, download=False)
    ...
    check = []
    count = 0
    for _, label in tqdm(test_dataset):
        # if count >= 10000:
        #     break
        # count += 1
        check.append(label)
